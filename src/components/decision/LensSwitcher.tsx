    ...
    <div className="px-8 pt-3 pb-2 border-b border-border bg-background">
      <div className="flex items-start gap-4">
        <div className="flex items-start">
          <span className="font-mono text-[10px] uppercase tracking-[0.15em] text-muted-foreground/70 pt-1">
            {t("nav.lens")}
          </span>
          <span aria-hidden className="inline-block w-px h-3.5 bg-border mx-3 mt-1.5" />
                ...
                >
                  ...
                  {isActive && (
                    <>
                      ...
                      <span
                        key={`sub-${l.id}`}
                        className="block font-serif italic text-[12px] text-muted-foreground mt-1.5 animate-fade-in"
                      >
